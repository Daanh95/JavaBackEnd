...
spring.datasource.url=jdbc:mysql://localhost:3306/voeding?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC
